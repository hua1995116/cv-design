...
<template>
      ...
      <div :style="containerStyle">
        <div :style="cardStyle">
          <div class="banner" :style="layer0">
            <img src="/images/5240315.jpg" alt="banner" />
          </div>
        </div>
      </div>
    </div>
  ...
  <footer class="footer">
    <div class="footer-main">
      <h4>Links</h4>
      <a
        href="https://github.com/hua1995116/cv-design"
      ...
      <a
        href="https://github.com/hua1995116/cv-design/releases"
        class="footer-main-link"
        target="_blank"
      >
        更新日志
    ...
    <div class="footer-main">
      ...
      >
      <a
        href="https://github.com/nan980914"
        class="footer-main-link"
        target="_blank"
      >
        楠溪
